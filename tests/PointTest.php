...
class PointInTimeTest extends TestCase
{
    ...
    {
        $point = Point::at(new \DateTimeImmutable('2016-10-05T08:01:30.123+02:00'));
    ...
    {
        $point = Point::at(new \DateTimeImmutable('2016-10-05T08:01:30.999678+02:00'));
    ...
    {
        $point = Point::at(new \DateTimeImmutable('2016-10-05T08:01:30.123+02:00'));
        $point2 = Point::at(new \DateTimeImmutable('2016-10-05T08:03:30.234+02:00'));
    ...
    public function testEquals()
    {
        $point = Point::at(new \DateTimeImmutable('2016-10-05T08:01:30.123+02:00'));
        $point2 = Point::at(new \DateTimeImmutable('2016-10-05T08:03:30.234+02:00'));
        $point3 = Point::at(new \DateTimeImmutable('2016-10-05T08:01:30.123+02:00'));
    ...
    {
        $point = Point::at(new \DateTimeImmutable('2018-03-04'));
    ...
    {
        $point = Point::at(new \DateTimeImmutable('1402-07-21 02:42:53.000000'));
